...
//This method is used for fetching a single to-do item using "GET" method
export const get = async (req, res) => {
    try {
        const id = req.params.id;

        //Calls the get method present in todo-service.js file for searching a existing to-do item based on the id passed
        const todoId = await todoService.get(id);
        setResponse(todoId, res);
